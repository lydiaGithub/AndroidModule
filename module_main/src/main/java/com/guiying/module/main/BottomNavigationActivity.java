...
public class BottomNavigationActivity extends BaseActivity {
    ...
    private void initViewPager() {
        ...
        BaseFragment baseFragment1 = (BaseFragment) ARouter.getInstance().build("/news/NewsFragment").navigation();
        BaseFragment baseFragment2 = (BaseFragment) ARouter.getInstance().build("/girls/GirlsFragment").navigation();
